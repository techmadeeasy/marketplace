<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard.listings.index') }}">
                        <img src="{{ asset('/assets/img/default-monochrome-white.svg') }}" alt="My Logo" width="165" height="16">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.listings.index')" :active="request()->routeIs('dashboard.listings.index')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard.listings.index')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
